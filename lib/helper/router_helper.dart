...
class RouterHelper {
  ...
  static String getOrderDetailsRoute(String? id, {String? phoneNumber,RouteAction? action}) => _navigateRoute('$orderDetailsScreen?id=$id&phone=${Uri.encodeComponent('$phoneNumber')}', route: action);
