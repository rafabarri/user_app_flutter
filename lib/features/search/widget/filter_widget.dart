                ...
                SizedBox(height: 30, child: CustomScrollView(scrollDirection: Axis.horizontal, slivers: [
                  SliverList.builder(
                    ...
                    itemBuilder: (context, index) => Padding(
                      ...
                      child: Material(
                        color: searchProvider.selectedPriceIndex == index ? Theme.of(context).primaryColor.withValues(alpha:0.9) : Colors.transparent,
                        borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                        ...
                        child: InkWell(
                          ...
                          child: Tooltip(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: searchProvider.selectedPriceIndex == index ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withValues(alpha:0.5),
                                ),
                                borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                              ),
                              child: Text(
