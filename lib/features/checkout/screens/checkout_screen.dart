...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Future<void> _onInitLoad() async {
    ...
    if(_isLoggedIn || (splashProvider.configModel?.isGuestCheckout ?? false)) {
      ...
      selectedDeliveryAddress = await CheckOutHelper.selectDeliveryAddressAuto(orderType: checkoutProvider.orderType, isLoggedIn: (_isLoggedIn || isGuestCheckout), lastAddress: lastDeliveryAddress);
